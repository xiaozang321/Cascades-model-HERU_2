model.initial = function(par, diag18){
  with(as.list(c(par, diag18 = diag18)), {
    ...
    pop.pwid.m = pop.total *prop.pwid.among.total *prop.male.among.pwid* (1-prop.mpwid.among.pwid)
    pop.midu   = pop.total *prop.pwid.among.total *prop.male.among.pwid* prop.mpwid.among.pwid
    ...
    # indicator for population groups:
